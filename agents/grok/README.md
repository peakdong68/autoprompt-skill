...
```bash
autoprompt activate grok --target <absolute-project> -- <request>
```
...
Native format reference: [Grok Build documentation](https://docs.x.ai/build/features/skills-plugins-marketplaces).
