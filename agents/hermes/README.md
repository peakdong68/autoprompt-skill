...
```bash
autoprompt activate hermes --target <absolute-project> -- <request>
```
...
Native format reference: [Hermes Agent documentation](https://hermes-agent.nousresearch.com/docs).
